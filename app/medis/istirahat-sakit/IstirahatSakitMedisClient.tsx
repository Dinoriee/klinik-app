...
export default function IstirahatSakitMedisClient({ dataList, query }: { dataList: PresensiSakit[], query: string }) {
        ...
        <div className="flex flex-col gap-4 relative">
            ...
            <div className="flex justify-between items-center p-4">
                <div className="flex flex-col">
                    <h1 className="text-gray-400">Medis / <span className="text-black font-bold">Riwayat Istirahat Sakit</span></h1>
                </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border mx-4 mb-4">
                <div className="flex justify-between items-center mb-6 border-b pb-4">
                    <h2 className="font-bold text-lg text-black">Daftar Pasien Istirahat Sakit</h2>
                    <div className="flex space-x-3">
                        ...
                        {}
                        <Link href="/medis/istirahat-sakit/tambah">
                            <button className="bg-blue-600 text-white hover:bg-blue-700 px-4 py-2 rounded-md transition-colors text-sm font-medium flex items-center gap-2">
                    ...
                    <table className="w-full text-left text-sm">
                        <thead className="bg-gray-50 border-y text-gray-500">
                            <tr>
                                ...
                                <th className="px-4 py-3 font-medium">Tanggal Pemberian</th>
                        ...
                        <tbody className="divide-y">
                            {currentData.length === 0 ? (
                                <tr><td colSpan={6} className="text-center py-6 text-gray-400">Belum ada riwayat pasien sakit.</td></tr>
                            ) : (
