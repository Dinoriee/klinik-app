...
export default function ScannerKonsultasiDokter({ onScanSuccess }: ScannerProps) {
  ...
  return (
    <div className="relative border-8 border-gray-800 rounded-2xl overflow-hidden bg-black w-full max-h-96 shadow-2xl">
      {loading && (
